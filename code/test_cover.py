...
# 使用 splprep 拟合 B 样条曲线
tck, u = splprep(points, s=0.001, k=3)  # s 为平滑参数，k 为样条阶数
...
plt.scatter(x, y, color='red', label='Noisy Points', alpha=0.5)
plt.plot(x_new, y_new, 'b-', label='Spline Curve')
plt.xlabel('x')
plt.ylabel('y')
plt.title('Spline Interpolation of Noisy Point Cloud')
plt.legend()
plt.grid(True)
plt.show()
